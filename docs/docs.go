    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.PasswordChangeRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/delete-account": {
            "delete": {
                ...
                "parameters": [
                    {
                        "description": "Password Konfirmasi",
                        "name": "password",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/touring": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Cari berdasarkan nama atau tujuan touring",
                        "name": "search",
                        "in": "query"
                    }
                ],
        ...
        "/api/upload-profile-photo": {
            "post": {
                ...
                "parameters": [
                    {
                        "type": "file",
                        "description": "Foto profil (JPG, PNG, GIF, max 5MB)",
                        "name": "file",
                        "in": "formData",
                        "required": true
                    }
    ...
    "definitions": {
        ...
        "model.User": {
            ...
            "properties": {
                ...
                "email": {
                    "description": "Changed: removed NOT NULL to handle existing data",
                    "type": "string"
                },
                "email_verified": {
                    "type": "boolean"
